...
def parse_config(argv=None):
    ...
    # BioTUCH 
    parser.add_argument('--init_pose_path', type=str, default=None,
                        help='The file where the initialization pose is'
                             ' is stored. This will be used for initialization')

    parser.add_argument('--bio_contact_weight',
                        default=0.0,
                        type=float,
                        help='The weight of the bioimpedance constraint')
    parser.add_argument('--bio_contact', type=int,
                    default=0,
                    help='Contact status for this frame (0 or 1)')
    parser.add_argument('--init_body_folder', type=str,
                    default=None,
                    help='Path to folder containing MultiHMR initialization files')
    # Add these in cmd_parser.py near the other BioTUCH related arguments:
    parser.add_argument('--contact_weight',
                        default=10.0,
                        type=float,
                        help='Weight for contact component of BioTUCH loss')

    parser.add_argument('--consistency_weight',
                        default=0.25,
                        type=float,
                        help='Weight for consistency component of BioTUCH loss')

    parser.add_argument('--penetration_weight',
                        default=1.0,
                        type=float,
                        help='Weight for penetration prevention component of BioTUCH loss')
    
    parser.add_argument('--frame_loss_weight',
                        default=1.0,
                        type=float,
                        help='Weight for frame loss component')
    ...
    parser.add_argument('--transl_globalorient_path', type=str, default=None,
                        help='The file where the transl and global orientation'
                             ' is stored. This will be used for initialization')
